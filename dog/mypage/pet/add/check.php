...
<article>
  <?php mypage_nav(); ?>
  <div class="flL area">
        <section id="check_form" class="cfx">
            <form action="finish.php" method="post">
                ...
                <h3>ペットの生年月日</h3>
                <?php if($pet_day != ""){ ?>
								<p class="<?=$pet_year?>"><?php print htmlspecialchars($pet_year) ?>年<?php print htmlspecialchars($pet_month) ?>月<?php print htmlspecialchars($pet_day) ?>日</p>
								<?php }else{ ?>
            ...
            <form action="../change/?pet_id=<?=$_SESSION["pet"]?>" method="post">
                ...
                <input type="hidden" name="nen" value="<?php print htmlspecialchars($_POST["umare1"]) ?>"><!--年-->
                <input type="hidden" name="tuki" value="<?php print htmlspecialchars($_POST["umare2"]) ?>"><!--月-->
                <input type="hidden" name="hi" value="<?php print htmlspecialchars($_POST["umare3"]) ?>"><!--日-->
