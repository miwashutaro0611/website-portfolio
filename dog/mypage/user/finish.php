...
require_once("../../core/user_update.php");
...
$level = '../../';
//使用するcssを記入
$css = '<link rel="stylesheet" href="../../css/user.css" type="text/css" />';
//使用するjavascript(jQuery)を記入
$js = '';
//サイトのタイトルを記入
$title = 'ユーザ情報更新-完了｜ワンコム';
//サイトのキーワードを記入(表示には関係ない・任意)
$keywords = '犬,里親,コミュニティ,飼い主';
//サイトの説明文を記入(表示には関係ない・任意)
$description = 'ワンコムユーザ情報更新完了です。ワンコムを利用してさまざまな人と交流を持ちましょう！';
...
<article>
    <section id="finish">
        <h2>ユーザ情報登録完了</h2>
	        <p class="text">ユーザ情報の登録が完了いたしました。引き続きワンコムをお楽しみください。</p>
