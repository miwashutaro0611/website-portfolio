...
require_once("../../core/mypagefriend_list.php");
...
$description = 'ワンコムフォロー一覧ページです。ワンコムを利用してさまざまな人と交流を持ちましょう！';
...
<div class="panlist">
	<ol class="cfx pankuzu">
		...
		<span class="flL">></span>
		<li class="flL"><a href="../../mypage/friend/">フォロー一覧</a></li>
	</ol>
</div>
<!--ここからコンテントの内容始まる　-->
<article>
	...
	<div class="flL">
		<section id="myfriends">
			...
			<?php for($i=0;$i<count($MYID);$i++){ ?>
				<li class="flL">
					<h3><img src="../../img/user_img/<?=$PET_FRIEND_IMAGE[$i]?>" width="120" height="120"/></h3>
